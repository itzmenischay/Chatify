          ...
          <div className="flex">
            ...
            <motion.div
              ...
              <div className="w-full max-w-md px-2 sm:px-4">
                ...
                <div className="flex flex-row justify-center items-center mt-5 sm:text-xs md:text-xs text-center">
                  <Link to="/login" className="flex justify-center items-center auth-link text-sm">
